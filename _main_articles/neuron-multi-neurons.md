...
In this section, we provide visualization results of neurons for all positive input values. We use random weight $W$ and bias $b$. In this case, the number of neurons is  8 and the input dimension is 1. In addition, we specifically highlight two cases, Input 1 and Input 2. 
