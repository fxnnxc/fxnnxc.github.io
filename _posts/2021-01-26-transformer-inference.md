...
**Inference stage** of the transformer architecture is different with RNN case. When we encode a source sentence, we get a hidden state of the source. When we decode that hidden state, we should generate tokens one by one. 
